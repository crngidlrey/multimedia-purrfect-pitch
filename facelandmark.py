#!/usr/bin/env python3
"""
facelandmark_random.py
Realtime face landmark + cat overlay + head-tilt selection.
When user holds tilt left/right for HOLD_TIME, images randomly change.

Requirements:
  pip install mediapipe opencv-python numpy
Run:
  python facelandmark_random.py
Exit: press ESC
"""
